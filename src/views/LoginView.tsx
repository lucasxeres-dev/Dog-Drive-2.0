                    ...
                    <div className="relative z-10 p-16 xl:p-24 flex flex-col justify-between h-full">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#22eb7e]">{t('vibe_premium')}</span>
                            </div>
                            <h2 className="text-6xl xl:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-4">
                                {t('match_story_1')} <span className="text-[#22eb7e]">{t('match_story_2')}</span> <br />{t('match_story_3')}
                            </h2>
                            <p className="text-white/40 font-bold text-lg xl:text-xl tracking-tight max-w-md">{t('match_story_desc')}</p>
                        </motion.div>
                    </div>
                </div>
